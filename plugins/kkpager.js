...
define('kkpager',['jquery'],function($) {
	var kkpager = {
		...
		generPageHtml: function (config, enforceInit) {
			...
			if (this.isShowFirstPageBtn) {
				if (this.hasPrv) {
					str_first = '<a ' + this._getHandlerStr(1) + ' title="'
						+ (this.lang.firstPageTipText || this.lang.firstPageText) + '" data-page="1">' + this.lang.firstPageText + '</a>';
				} else {
			...
			if (this.isShowPrePageBtn) {
				if (this.hasPrv) {
					str_prv = '<a ' + this._getHandlerStr(this.prv) + ' title="'
						+ (this.lang.prePageTipText || this.lang.prePageText) + '" data-page="'+this.prv+'">' + this.lang.prePageText + '</a>';
				} else {
			...
			if (this.isShowNextPageBtn) {
				if (this.hasNext) {
					str_next = '<a ' + this._getHandlerStr(this.next) + ' title="'
						+ (this.lang.nextPageTipText || this.lang.nextPageText) + '" data-page="'+this.next+'">' + this.lang.nextPageText + '</a>';
				} else {
			...
			if (this.isShowLastPageBtn) {
				if (this.hasNext) {
					str_last = '<a ' + this._getHandlerStr(this.total) + ' title="'
						+ (this.lang.lastPageTipText || this.lang.lastPageText) + '" data-page="'+this.total+'">' + this.lang.lastPageText + '</a>';
				} else {
			...
			if (this.isGoPage) {
				gopage_info = '<span class="goPageBox">' + this.lang.gopageBeforeText + '<span id="' + this.gopageWrapId + '">' +
					...
					'<input type="text" id="' + this.gopageTextboxId + '" value="' + this.next + '" /></span>' + this.lang.gopageAfterText + '</span>';
			}
				...
				for (var i = 1; i <= this.total; i++) {
					if (this.pno == i) {
						...
						str += '<a ' + this._getHandlerStr(i) + ' title="'
							+ this.lang.buttonTipBeforeText + i + this.lang.buttonTipAfterText + '" data-page="'+i+'">' + i + '</a>';
					}
				}
			} else {
				if (this.pno <= 5) {
					...
					str += '<a ' + this._getHandlerStr(1) + ' title="'
						+ this.lang.buttonTipBeforeText + '1' + this.lang.buttonTipAfterText + '"  data-page="1">1</a>';
					str += '<a ' + this._getHandlerStr(2) + ' title="'
						+ this.lang.buttonTipBeforeText + '2' + this.lang.buttonTipAfterText + '" data-page="2">2</a>';
					str += dot;
			...
			$("#" + this.pagerid).find('a').on('click', function (e) {
				var pageNo = $(this).data('page');
				that._clickHandler(pageNo);
			});
			$("#" + this.pagerid).find('input[type="button"]').on('click', function (e) {
				that.gopage();
			});
			//onfocus="kkpager.focus_gopage()"  onkeypress="return kkpager.keypress_gopage(event);"   onblur="kkpager.blur_gopage()"
			$("#" + this.pagerid).find('input[type="text"]').on('focus', function (e) {
				that.focus_gopage();
